...
using System.Linq;
using UnityEngine;
[CreateAssetMenu(fileName = "Assets/Scripts/Algorithms/DrunkenRiverGeneration", menuName = "Algorithms/DrunkenRiverGeneration")]
public class DrunkenRiverGeneration : AlgorithmBase
{
    ...
    public override void Apply(TilemapStructure tilemap)
    {
        ...
        for (int i = 0; i < amountOfRivers; i++)
        {
            ...
            var endPos = TilemapHelper.FindClosestTileByType(tilemap, startPoint.Value, (int)GroundTileType.UndeepWater);
